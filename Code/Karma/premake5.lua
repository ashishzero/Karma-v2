project "Karma"
   ...
   vpaths {
        ...
        ["Kr/Basic"] = {
         ...
         ["Kr/Image"] = { "Kr/Image/stb_image.h", "Kr/Image/stb_image_write.h" },
         ["Kr/ImGui"] = { "Kr/ImGui/*.h", "Kr/ImGui/*.cpp", "kImGui.h" },
         ...
         ["Kr/Render"] = { "Kr/kRender.h", "Kr/kRender.cpp", "Kr/kRenderShared.h", "Kr/kRenderShared.cpp", "Kr/kRenderCommand.h" },
         ["Kr/Render/Backend"] = { "Kr/kRenderBackend.h", "Kr/kRenderBackend.cpp", "Kr/kRenderResource.h", "Kr/kRenderResource.cpp" },
         ["Kr/Render/D3D11"] = { "Kr/kRenderBackendD3D11.cpp", "Kr/kD3DShaders.h" },
         ["Kr/Windows"] = { "Kr/kWindowsCommon.h", "Kr/kMediaBackendWin32.cpp" },
