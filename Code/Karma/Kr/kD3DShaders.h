...
static const kString PixelShadersMap[] = {kString(kQuadPS), kString(kBlitPS)};
static_assert(kArrayCount(PixelShadersMap) == kPixelShader_Count, "");

static const kString ComputeShadersMap[] = {kString(kThresholdCS), kString(kBloomDownSampleCS), kString(kToneMapCS)};
