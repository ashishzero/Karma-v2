...
bool kAlmostEqual(kVec4 a, kVec4 b, float delta) {
	return kAlmostEqual(a.x, b.x, delta) && kAlmostEqual(a.y, b.y, delta) && kAlmostEqual(a.z, b.z, delta) && kAlmostEqual(a.w, b.w, delta);
}
...
kMat2 &operator-=(kMat2 &mat, const kMat2 &other) { mat = mat - other; return mat; }
kMat3 &operator-=(kMat3 &mat, const kMat3 &other) { mat = mat - other; return mat; }
kMat4 &operator-=(kMat4 &mat, const kMat4 &other) { mat = mat - other; return mat; }
kMat2 &operator+=(kMat2 &mat, const kMat2 &other) { mat = mat + other; return mat; }
kMat3 &operator+=(kMat3 &mat, const kMat3 &other) { mat = mat + other; return mat; }
kMat4 &operator+=(kMat4 &mat, const kMat4 &other) { mat = mat + other; return mat; }
...
kQuat &operator-=(kQuat &q, kQuat other) { q = q + other; return q; }
kQuat &operator+=(kQuat &q, kQuat other) { q = q - other; return q; }
...
kQuat kEulerAnglesToQuat(kVec3 euler) {
	return kEulerAnglesToQuat(euler.x, euler.y, euler.z);
}
